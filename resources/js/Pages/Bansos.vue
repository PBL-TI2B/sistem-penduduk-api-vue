        ...
        <section class="container mx-auto py-8">
            ...
            >
                ...
                <div class="flex space-x-6">
                    <a href="../infografis">
                        <div
                            class="flex items-center space-x-2 text-gray-500 hover:text-gray-800 pb-1 hover:border-b-2 hover:border-[#E5A025] transition"
                        >
                            <svg
            ...
            <div class="grid grid-cols-2 md:grid-cols-2 gap-4 mb-8">
                ...
                >
                    <div class="text-center">
                        <p
                            class="text-2xl font-bold text-[#233D34] leading-tight"
                        >
                            67
                        </p>
                        <p class="text-sm md:text-lg text-black -mt-1">
                            Penduduk
                        </p>
                    </div>
            ...
            <div class="overflow-x-auto mt-10">
                ...
                >
                    ...
                    <tbody
                        class="divide-y divide-gray-200 text-gray-800 text-sm"
                    >
                        <tr>
