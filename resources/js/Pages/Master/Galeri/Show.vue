...
<template>
    ...
    <div class="shadow-md p-4 rounded-lg flex flex-col lg:flex-row gap-8 justify-between">
        ...
        <img :src="galeri.url_media ? (galeri.url_media.startsWith('http') ? galeri.url_media : '/storage/' + galeri.url_media) : 'https://placehold.co/400x300?text=No+Image'"
            alt="Foto Galeri" loading="lazy" class="rounded-md w-[400px] h-[300px] object-cover border" />
    </div>
