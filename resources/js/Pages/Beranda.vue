    ...
    <div class="bg-[#0E462B] text-gray-800">
        ...
        >
          <div class="absolute inset-0 bg-black opacity-40"></div>
            <div
                class="absolute inset-0 flex flex-col justify-start items-center text-white text-center"
            >
        ...
        <div class="relative z-10 -mt-60 mx-5">
          <div class="px-6 py-6 max-w-6xl mx-auto md:px-auto flex justify-center items-center text-white" style="background-image: url('/images/ellipseStat.svg'); background-size: contain; background-repeat: no-repeat; background-position: center; min-height: 475px;">
        ...
        <section class="bg-green-800 mx-4 max-w-6xl lg:mx-auto -mt-36 sm:-mt-20 md:mt-8 lg:mt-10 text-white mb-3 lg:mb-5 rounded-xl lg:px-16 lg:py-10 px-6 py-4">
          <div class="container mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div class="flex justify-center md:justify-end">
              <img src="@/images/kepala-desa.png" alt="Kepala Desa" class="w-60 h-60 rounded-full object-cover">
            </div>
        ...
        <section class="mx-4 max-w-6xl lg:mx-auto mt-10">
          ...
          <div id="scrolling-wrapper" class="flex whitespace-nowrap gap-4 pb-4">
            ...
            <div class="flex-shrink-0 w-64 bg-green-800 rounded-xl shadow-lg text-center">
              <img src="@/images/kepala-desa.png" class="w-64 h-64 object-cover mr-0 mb-2 rounded-t-lg" alt="Foto">
          ...
          <div class="mx-4 max-w-6xl lg:mx-auto">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
              ...
              <div class="rounded flex flex-col items-left text-left">
                <img src="@/images/berita-utama.png" class="mb-4 rounded-xl w-full" alt="Berita">
              ...
              <div class="flex flex-col gap-4 justify-between">
                ...
                <img src="@/images/berita-lain.png" class="w-32 h-20 md:w-64 md:h-36 object-cover rounded-sm md:rounded-lg" alt="Berita kecil">
                  <div>
        ...
        <section class="bg-[#0E462B] pt-12 pb-8 md:pb-12 max-w-6xl mx-4 lg:mx-auto ">
          ...
          <img src="@/images/kepala-desa.png" alt="Galeri 1" class="w-full rounded-xl object-cover">
            <img src="@/images/kantor-desa.png" alt="Galeri 2" class="w-full rounded-xl object-cover">
            <img src="@/images/berita-utama.png" alt="Galeri 3" class="w-full rounded-xl object-cover">
            <img src="@/images/kepala-desa.png" alt="Galeri 4" class="w-full rounded-xl object-cover">
            <img src="@/images/berita-lain.png" alt="Galeri 5" class="w-full rounded-xl object-cover">
            <img src="@/images/kantor-desa.png" alt="Galeri 6" class="w-full rounded-xl object-cover">
            <img src="@/images/kepala-desa.png" alt="Galeri 5" class="w-full rounded-xl object-cover">
            <img src="@/images/kantor-desa.png" alt="Galeri 6" class="w-full rounded-xl object-cover">
