    ...
    "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
    {
        variants: {
            variant: {
                ...
                frontend:
                    "cursor-pointer rounded-full bg-gradient-to-r from-emerald-500 to-emerald-600 text-primary-foreground shadow-xs hover:bg-gradient-to-r hover:from-emerald-600 hover:to-emerald-500 duration-300",
                frontendOutline:
                    "cursor-pointer rounded-full bg-background shadow-xs hover:bg-gradient-to-r hover:from-emerald-600 hover:to-emerald-500 hover:text-primary-foreground duration-300",
                frontendGhost:
                    "bg-emerald-100 rounded-full text-emerald-600 hover:bg-emerald-200 hover:text-emerald-700 duration-200 transition-colors",
            },
            size: {
