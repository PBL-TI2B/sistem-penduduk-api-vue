...
<template>
    ...
    >
        <SheetContent
            ...
            data-mobile="true"
            :side="side"
            class="bg-sidebar-primary text-sidebar-primary-foreground w-(--sidebar-width) p-0 [&>button]:hidden"
            :style="{
    ...
    <div
        v-else
        class="group peer text-sidebar-primary-foreground hidden md:block"
        data-slot="sidebar"
        :data-state="state"
